...
public class KMeans {
	...
	public static int selectCentroidforPoints(Point point, Centroids[] centroids, int dimension) {
	...
	public static Centroids[] KMeans(Point[] points, int numPoints, int numCentroids, int dimension, int maxIter, double threshold) {
		...
		do {
			...
			for (int i = 0; i < numPoints; i++) {
				Point p = points[i];
				int selectedCentroid = selectCentroidforPoints(p, centroids, dimension);
				includePointtoCentroid(centroids[selectedCentroid], p);
			}
	...
	public static void crossValidation(Point[] points, int numPoints, int numCentroids, int dimension, int maxIter, double threshold) {
		...
		for (int partitionIdx = 0; partitionIdx < numOfPartitions; partitionIdx++) {
			...
			//Train the data 
			Centroids[] centroids = KMeans(trainPoints, partitionSize * 9, numCentroids, dimension, maxIter, threshold);
			//Test the data
			int TP = 0, FP = 0;
			for(int i = 0; i < partitionSize-1; i++) {
				int selectedCentroid = selectCentroidforPoints(testPoints[i], centroids, dimension);
	...
	public static void main(String[] args) {
		...
		//KMeans(points, numPoints, 8, dimension, 1000, 0.0001);
		crossValidation(points, numPoints, 8, dimension, 1000, 0.0001);
	}
}
